...
import (
	...
	"github.com/bugnanetwork/bugna-stratum-bridge/src/utils"
)
...
func newShareHandler(bugna *rpcclient.RPCClient) *shareHandler {
	return &shareHandler{
		bugna:     bugna,
		stats:     map[string]*WorkStats{},
		statsLock: sync.Mutex{},
...
func (sh *shareHandler) submit(ctx *gostratum.StratumContext,
	...
	_, err := sh.bugna.SubmitBlock(block)
